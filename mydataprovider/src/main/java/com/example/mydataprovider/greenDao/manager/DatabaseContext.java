...
import com.example.mycommon.utils.EmptyUtils;
...
public class DatabaseContext extends ContextWrapper {
    ...
    public DatabaseContext(Context context, String currentUserId) {
        super(context);
...
//        String dbDir = Environment.getExternalStorageDirectory().getPath();
        if (EmptyUtils.isNotEmpty(currentUserId)) {
            currentUserId = Constants.currentUserId;
        }
        String dbDir = Constants.SDCARD_PATH + currentUserId + "/";
